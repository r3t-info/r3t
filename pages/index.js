...
export function IntroductionParagraph(props) {
  return (
    <p className="text-xl leading-snug sm:px-10 sm:leading-normal">{props.children}</p>
  );
}

export function ClientsParagraph(props) {
  return <p className="text-light text-xl leading-tight lg:leading-snug mx-auto text-center w-48">{props.children}</p>;
}
...
export function OurMethodParagraph(props) {
  return <p className="text-xl leading-snug text-center lg:max-w-sm lg:mx-10 xl:mx-5 xl:w-1/4">{props.children}</p>;
}
    ...
    <>
      ...
      <header className="px-2 pt-4 pb-3 sm:pt-6 xl:pt-8 lg:pb-0 bg-dark">
        <div className="h-16 sm:h-20">
          <R3tLogo className="h-full mx-auto fill-current text-light" />
        </div>
      </header>
      <main>
        <section id="who-we-are" className="bg-who-we-are bg-cover bg-left">
          ...
          <div className="flex justify-center px-4 mt-12 mb-10 xl:mt-16 xl:mb-5">
            <div className="bg-light shadow-md inline-block rounded-md sm:rounded-lg border border-accent border-opacity-5 px-3 sm:px-0 sm:pb-4 md:pb-3 max-w-sm sm:max-w-lg">
              <h2 className="text-secondary py-5 sm:pt-8 sm:pb-4 max-w-sm mx-auto leading-tight">Changing Digital Leadership</h2>
              <ReactMarkdown
      ...
      <footer id="contact" className="bg-dark px-4 pb-2">
        <h2 className="text-primary text-3xl lg:text-4xl font-medium normal-case leading-tight pt-12 xl:pt-20 md:pt-16 max-w-sm mx-auto mb-6 md:mb-3 lg:mb-8 xl:mb-12 xl:font-bold">
        ...
        <div className="w-32 sm:w-40 lg:w-full mx-auto mt-5 mb-6 lg:mt-2 lg:mb-10">
          <R3tLogo className="h-full mx-auto lg:h-16 fill-current text-light" />
        </div>
      </footer>
    </>
  );
