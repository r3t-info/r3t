...
export default function Client({ clientData }) {
  ...
  return (
    <div
      ...
      className="bg-light shadow-md border border-accent border-opacity-50 rounded-md sm:rounded-lg max-w-sm md:max-w-xs mx-auto md:mx-6 md:mb-8 md:self-start xl:mb-16 p-3 sm:p-4 md:p-3 md:pb-4 xl:pt-4 xl:pb-5 lg:px-4 xl:px-6 flex flex-col xl:max-w-sm xl:mx-10 xl:shadow-xl"
    >
